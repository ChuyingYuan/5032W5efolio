...
const showFriendMessage = ref(null)

const submitForm = () => {
  validateName(true);
  validatePassword(true);
  validateReason(); // Ensure reason validation is called during form submission
...
const validateReason = (blur) => {
  ...
  if (reason.includes('friend')) {
    showFriendMessage.value = 'Great to have a friend'
  } else {
    showFriendMessage.value = null
  }
      ...
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            <div v-if="showFriendMessage" style="color: green;">{{ showFriendMessage }}</div>
          </div>
